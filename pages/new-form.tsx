    ...
    return (
        <div className="px-4">
            ...
            <form method="post" action="https://hyperform.jp/api/kzhZu7sN">
                ...
                <Content title="お名前">
                    <input className="p-5 outline-none" type="text" name="お名前" required />
                </Content>
                <Content title="件名">
                    <input className="p-5 outline-none" type="text" name="件名" required />
                </Content>
                <Content title="お問い合わせ内容">
                    <textarea className="p-10 outline-none" name="お問い合わせ内容" required />
                </Content>
